...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./client/css/review_list.css" />
 ...
 %>
		...
		<div class="container content_div" align=center>	
			<ul class="pager pagination">
				<%
					if (prevpage != 0) {
				%> <li class="previous"><a href="./BoardList.bo?page=<%=prevpage%>">&lt;&lt;</a></li> <%
 					}
 				%>
 <%
					if (nowpage <= 1) {
 ...
 %> <li><a href="./BoardList.bo?page=<%=nowpage - 1%>">&lt;</a></li> <%
 	}
 %>
 ...
 <%
					if (nextpage != 0) {
				%> <li class="next"><a href="./BoardList.bo?page=<%=nextpage%>">&gt;&gt;</a></li> <%
 					}
 				%>
